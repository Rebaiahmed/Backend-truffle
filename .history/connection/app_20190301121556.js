...
CreateProduct: function( callback) {
  ...
  self.web3.eth.defaultAccount=self.web3.eth.coinbase;
    ...
    Food.deployed().then(function(instance) {
      ...
      return food.addProduct("Fruits", "Orange","111",0,1,{from:self.web3.eth.defaultAccount,
        gas:3000000 });
    }).then(function() {
      console.log('success')
      callback("success");
...
CreateFarmer: function(farmerdata, callback) {
  ...
  self.web3.eth.defaultAccount=self.web3.eth.coinbase;
    ...
    Food.deployed().then(function(instance) {
      food = instance;
      console.log('instance is' + food)
      return food.addFarmer("ahemd","ahmed","tets@mail.com","20140428","zitoun",{from:self.web3.eth.defaultAccount,
        gas:3000000 });
    }).then(function() {
      console.log('success')
      callback("success");
   ...
   Food.setProvider(self.web3.currentProvider);
    ...
    var food;
     ...
     // self.web3.eth.defaultAccount=self.web3.eth.accounts[0]
      //console.log('adress' +self.web3.eth.defaultAccount);
     //self.web3.eth.defaultAccount = 0xD648C38007993e994bb3ff37911Dc9D3ab4447C3;
       self.web3.eth.defaultAccount=self.web3.eth.accounts[0];

       console.log('teh addresss'+ self.web3.eth.defaultAccount);
//0x5211d31f24832e28Dd4025D660C19443AbD002AA
     /*farmerdata.firstName, farmerdata.lastName,
      farmerdata.email,farmerdata.phone,farmerdata.activity*/

      return  food.addFarmer("ahemd","ahmed","tets@mail.com","20140428","zitoun",{from:0x5211d31f24832e28Dd4025D660C19443AbD002AA
,
        gas:3000000 });
    }).then(function(data) {
...
CreateSupplier: function(supplierdata, callback) {
  ...
  Food.setProvider(self.web3.currentProvider);
    ...
    Food.deployed().then(function(instance) {
      ...
      return food.addSupplier(supplierdata.firstName, supplierdata.lastName,
      supplierdata.email,supplierdata.phone,supplierdata.companyName,{from:self.web3.eth.defaultAccount,
        gas:3000000 });
    }).then(function() {
      console.log('success')
      callback("success");
  ...
  Food.setProvider(self.web3.currentProvider);
    ...
    Food.deployed().then(function(instance) {
     food = instance;
      ...
      return food.addRetailer(retailerdata.firstName,retailerdata.lastName,
      retailerdata.email,retailerdata.phone,retailerdata.companyName,{from:self.web3.eth.defaultAccount,
        gas:3000000 });
    }).then(function() {
      console.log('success')
      callback("success");
