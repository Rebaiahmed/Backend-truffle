...
CreateFarmer: function(farmerdata, callback) {
  ...
  self.web3.eth.defaultAccount=self.web3.eth.coinbase;
    ...
    Food.deployed().then(function(instance) {
      ...
      return food.getFarmersNbr({from:self.web3.eth.defaultAccount,
        gas:3000000 });


    }).then(function(data) {
      console.log("data returend" + data);


      //callback("success");
  return food.addFarmer("Zitoun",{from:self.web3.eth.defaultAccount,
    gas:3000000 })
    .then(function(data2){
...
CreateSupplier: function(farmerdata, callback) {
  ...
  self.web3.eth.defaultAccount=self.web3.eth.coinbase;
    ...
    Food.deployed().then(function(instance) {
      ...
      return food.addSupplier(farmerdata.activity,{from:self.web3.eth.defaultAccount,
        gas:3000000 });
    }).then(function(data) {
...
CreateFarmer: function(farmerdata, callback) {
  ...
  self.web3.eth.defaultAccount=self.web3.eth.coinbase;
    ...
    Food.deployed().then(function(instance) {
      ...
      //console.log('instance is' + food.farmers[0]);
      console.log(self.web3.eth.defaultAccount);
      return food.addRetailer(farmerdata.activity,{from:self.web3.eth.defaultAccount,
        gas:3000000 });
    }).then(function(data) {
      console.log(JSON.stringify(data));
      callback("success");
