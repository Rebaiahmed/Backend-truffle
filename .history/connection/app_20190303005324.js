...
CreateSupplier: function(farmerdata, callback) {
  ...
  self.web3.eth.defaultAccount=self.web3.eth.coinbase;
    ...
    Food.deployed().then(function(instance) {
      ...
      //callback("success");
  return food.addSupplier("Magasin ",{from:self.web3.eth.defaultAccount,
    gas:3000000 })
    .then(function(data2){
...
getSuppliers: function(farmerdata, callback) {
  ...
  console.log('heheheh data 1' + JSON.stringify(data2));
     callback(Number(data)+1);
    }).catch(function(err){
      console.log('err adding retailer' + JSON.stringify(err));
    })
