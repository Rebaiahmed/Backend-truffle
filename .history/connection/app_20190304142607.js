  ...
  Food.deployed().then(function(instance) {
    ...
    console.log('data 2' + JSON.stringify(data2.length 
      ...
      let obj ={
       ...
       var currentDatef = new Date( data2[0]*1000).toLocaleDateString("en-US");
        // var datef = currentDatef.getDate();
        // var monthf = currentDatef.getMonth(); 
        // var yearf = currentDatef.getYear();
console.log("hi"+currentDatef)
        var currentDates = new Date(data2[1]*1000);
        var datesu = currentDates.getDate();
        var monthsu = currentDates.getMonth(); 
        var yearsu = currentDates.getFullYear();

        var currentDater = new Date(data2[2]*1000);
        var dater = currentDater.getDate();
        var monthr = currentDater.getMonth(); 
        var yearr = currentDater.getFullYear();

        let obj2 ={
          'hardate' : monthf+1 + "/" + datef + "/" + yearf,
          'shipdate' : monthsu+1 + "/" + datesu + "/" + yearsu,
         'retailerdate' : monthr+1 + "/" + dater + "/" + yearr,
         'FarmerAdress': data2[3] ,
         'supplierAddress': data2[4],
         'RetailerAddress' : data2[5],
         'idSupplier' : data2[6],
