...
self.web3.eth.defaultAccount=self.web3.eth.coinbase;
  ...
  Food.deployed().then(function(instance) {
    ...
    console.log(self.web3.eth.defaultAccount);
     ...
     return food.addProduct("type1","ornage",00000,"Tunis",0,1,{from:self.web3.eth.defaultAccount,
      gas:3000000 });


  }).then(function(data) {

    console.log('currentProduc' +  JSON.stringify(data));
    //callback("success");
return food.addFarmer("zitoun","tunis","bouhmid",{from:self.web3.eth.defaultAccount,
  gas:3000000 })
  .then(function(data2){

console.log('heheheh data 1' +  data);
