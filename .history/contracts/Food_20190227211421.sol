...
contract Food {
    ...
    function addProduct(bytes32 _pType,bytes32 _name,uint _harDate) public {
        productsCount ++;
        products[productsCount] = Product(productsCount,_pType,_name,_harDate,0,0,0,bytes32 ("Farmer"));
    }
