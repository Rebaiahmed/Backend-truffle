...
contract Food {
    ...
    // uint public ProfarmersCount;
    // uint public ProsuppliersCount;
    // uint public ProretailersCount;
    ...
    // add a supplier
    function addSupplier (string memory _activity,string memory _company,string memory _location) public returns (uint){
        suppliers.length ++;
    ...
    //add a retailer
    function addRetailer (string memory _activity,string memory _company,string memory _location) public returns (uint){
        retailers.length ++;
    ...
    function getPro(uint id, uint t ) private view returns (Product) {
        if(t==0){
            for (uint i=0; i<farmersPro.length;i++){
        ...
        if(t==1){
            for (uint i=0; i<suppliersPro.length;i++){
    ...
    // function getFarmersNbr() public view returns (uint){
    //     return farmers.length;
    // }

    // function getFarmerById(uint _idF) public view returns (uint ,string memory,string memory,string memory){
    //     return (farmers[_idF-1].id ,farmers[_idF-1].activity ,farmers[_idF-1].username ,farmers[_idF-1].location );
    // }

    // function getSuppliersNbr() public view returns (uint){
    //     return suppliers.length;
    // }

    // function getSupplierById(uint _idF) public view returns (uint ,string memory,string memory,string memory){
    //     return (suppliers[_idF-1].id ,suppliers[_idF-1].activity,suppliers[_idF-1].companyname ,suppliers[_idF-1].location  );
    // }

    // function getRetailersNbr() public view returns (uint ){
    //     return retailers.length;
    // }

    // function getRetailerById(uint _idF) public view returns (uint ,string memory,string memory,string memory){
    //     return (retailers[_idF-1].id ,retailers[_idF-1].activity,retailers[_idF-1].companyname ,retailers[_idF-1].location  );
    // }


  function getProducsNbr() public view returns (uint){
         return products.length;
 }
