...
contract Product {
    ...
    function getAddrOwner() public returns (uint) {
        return addrOwner;
    }
    
    function getAddrPrvOwner() public returns (uint) {
        return addrPrvOwner;
    }
    
    function getType() public returns (string memory) {
        return pType;
    }
    ...
    function getHarDate() public returns (uint) {
        return harDate;
    }
    ...
    function getCreator() public returns (uint) {
        return creator;
    }
    
    function getAddr() public returns (string memory) {
        return shipAddr;
    }
    
    function getShipped() public returns (bool) {
        return shipped;
    }
    
    function getIdProduct() public returns (uint) {
        return idProduct;
    }
    
    function getShipDate() public returns (uint) {
        return shipDate;
    }
